...
function capturarGeolocalizacao(): Promise<GeoCoords | null> {
  return new Promise((resolve) => {
    ...
    // técnico esperando geolocalização não é aceitável (decisão confirmada
    // com o usuário: sem localização não bloqueia o envio).
...
// essa foto + a OS numa única submissão). 1920px no lado maior mantém
// nitidez de sobra pra evidência/documentação e reduz o arquivo pra uma
// fração do tamanho original — só reduz, nunca aumenta foto já pequena.
const MAX_DIMENSAO_PX = 1920;
