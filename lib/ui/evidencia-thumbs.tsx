...
// o componente não sabe de `tipo`/`momento`, só desenha.
export type EvidenciaThumbItem = { url: string | null; label: string };

// Rótulo canônico a partir do tipo/momento da evidência (0014/0023/0025) —
